...
eType=tag.data('etype'),val=$('.history-input').val(),query=val?('?query='+val):'';page.openPage(eType,query);},openPage:function(fileName,query){chrome.tabs.query({windowId:chrome.windows.WINDOW_ID_CURRENT},function(tabs){var
