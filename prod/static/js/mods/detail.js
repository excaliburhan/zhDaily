...
else{page.importStatic(body,css,js);page.replaceImg(title,image,imageSource);}},error:function(){console.log('接口异常');}});},importStatic:function(body,cssArr,jsArr){var
